    ...
    public class Board : IPlayable.IPlayable
    {
        ...
        public void DrawBoard()
        {
            ...
            for (int line = 0; line < 8; line++)
            {
                ...
                {
                    Console.Write((theBoard[col, line] == (int)OthelloIA10.EtatCase.Empty) ? " -" : (theBoard[col, line] == (int)OthelloIA10.EtatCase.White) ? " O" : " X");
                }
                Console.Write("\n");
            }
            Console.WriteLine();
        ...
        public List<Tuple<int, int>> GetPossibleMoves(bool whiteTurn, bool show = false)
        {
            ...
            for (int i = 0; i < 8; i++)
                for (int j = 0; j < 8; j++)
                {
                    ...
                    {
                        possibleMoves.Add(new Tuple<int, int>(i, j + 1));
                        if (show == true)
